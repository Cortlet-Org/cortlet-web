...
export default function QuantpkgSidebar() {
    const pathname = usePathname();
    const [open, setOpen] = useState(false);

    const links = [
        { href: "/docs/quantpkg", label: "Introduction" },
        { href: "/docs/quantpkg/install", label: "Installation" },
        { href: "/docs/quantpkg/usage", label: "Usage" },
        { href: "/docs/quantpkg/packages", label: "Package Management" },
        { href: "/docs/quantpkg/config", label: "Configuration" },
        { href: "/docs/quantpkg/troubleshooting", label: "Troubleshooting" },
    ];
