            ...
            <div className="relative z-10 w-full max-w-md bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-800 shadow-xl rounded-2xl p-10 backdrop-blur">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <button
                        ...
                        className={`flex items-center justify-center gap-3 py-3 w-full rounded-lg border bg-white hover:bg-neutral-100 dark:bg-neutral-800 dark:border-neutral-700 dark:hover:bg-neutral-700 transition-all font-medium ${doingLogin ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center justify-center gap-3 py-3 w-full rounded-lg bg-black text-white hover:bg-neutral-900 transition-all font-medium ${doingLogin ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
